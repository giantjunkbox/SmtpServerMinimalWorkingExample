...
namespace SmtpServer.Storage
{
    public sealed class DelegatingMailboxFilter : MailboxFilter
    {
        ...
        public override MailboxFilterResult CanAcceptFromAsync(
            ISessionContext context,
            IMailbox @from,
            int size)
        {
            return _canAcceptDelegate(context, @from);
        }
        ...
        /// <param name="cancellationToken">The cancellation token.</param>
        /// <returns>The acceptance state of the mailbox.</returns>
        public override MailboxFilterResult CanDeliverToAsync(
            ISessionContext context,
            IMailbox to,
            IMailbox @from)
        {
            return _canDeliverDelegate(context, to, @from);
        }
    }
}