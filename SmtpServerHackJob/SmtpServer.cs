            ...
            using (var endpointListener = _options.EndpointListenerFactory.CreateListener(endpointDefinition))
            {
                ...
                while (cancellationToken.IsCancellationRequested == false)
                {
                    ...
                    Task.Factory.StartNew(() =>
                    {
                        ...
                        var stream = endpointListener.GetStreamAsync(sessionContext);
                        are.Set();
                        ...
                        {
                            sessionContext.NetworkClient.UpgradeAsync(_options.ServerCertificate, _options.SupportedSslProtocols);
                            cancellationToken.ThrowIfCancellationRequested();
                        }
